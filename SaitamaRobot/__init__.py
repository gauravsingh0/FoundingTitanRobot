...
if ENV:
    ...
    BOT_ID = int(os.environ.get("BOT_ID",5295407910))
...
updater = tg.Updater(TOKEN, workers=min(32,os.cpu_count() +4), request_kwargs={"read_timeout": 10, "connect_timeout": 10}, use_context=True, defaults = defaults)
